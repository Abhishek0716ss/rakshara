...
# This is the email you verified with SendGrid.
# It reads from Render's env, but falls back to your email for local testing.
VERIFIED_SENDER_EMAIL = os.environ.get('EMAIL_HOST_USER', 'medteknie@gmail.com')

# Set both of these to your verified email
DEFAULT_FROM_EMAIL = VERIFIED_SENDER_EMAIL
EMAIL_HOST_USER = VERIFIED_SENDER_EMAIL
# --- END OF NEW BLOCK ---